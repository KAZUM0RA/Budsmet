...
**1 ГБ пам'яті замість 12.** Застосунку цього вистачає (він займає близько
150 МБ), але запас малий. Щоб машина не зависала під час встановлення пакетів,
одразу додайте файл підкачки:
